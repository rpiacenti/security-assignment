(function() {
  ...
  "spa-demo.subjects.ThingInquiry"];
  function ThingEditorController($scope, $q, $state, $stateParams,
    Authz, Thing, ThingImage, ThingInquiry) {
      var vm=this;
      vm.create = create;
      vm.clear  = clear;
      vm.update  = update;
      ...
      function reload(thingId) {
        ...
        vm.inquiries = ThingInquiry.get({thing_id:itemId});
        vm.inqui2 = "";
        ...
        vm.images.$promise.then(
          ...
          $q.all([vm.item.$promise,vm.images.$promise,vm.inquiries.$promise]).catch(handleError);
        }
