(function() {
  ...
  function ThingsAuthzFactory(Authz, BasePolicy) {
    ...
    ThingsAuthz.prototype.canUpdateInquiry=function(thing) {
        return Authz.isOrganizer(thing)
    };
        ThingsAuthz.prototype.canRemoveInquiry=function(thing) {
        return Authz.isOrganizer(thing) ;
    };
    ThingsAuthz.prototype.canQueryInquiry=function(thing) {
      console.log("ThingsAuthz.canQueryInquiry", thing);
